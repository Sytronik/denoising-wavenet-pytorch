...
%      Version: $Id: wavwrite.m 10457 2018-03-28 14:32:59Z dmb $
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin<3
    writewav(y,8000,fs,'p'); % default is 8kHz, 16 bit
elseif nargin<4
    writewav(y,fs,n,'p'); % default is 16 bit
else
    switch n
        case 8
            writewav(y,fs,fn,'8p'); % write 8 bit fixed-point data
        case 16
            writewav(y,fs,fn,'p'); % default is 16 bit
        case 24
            writewav(y,fs,fn,'24p'); % write 24 bit fixed-point data
        case 32
            writewav(y,fs,fn,'v'); % write 32 bit floating-point data
        otherwise
